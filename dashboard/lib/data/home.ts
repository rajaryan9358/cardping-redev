...
export async function getHomeSummary(): Promise<HomeSummary> {
  ...
  if (!res.ok) {
    return { totalContacts: 0, totalEvents: 0, scansThisWeek: 0, scansTrendPct: null, contactsTrendPct: null, eventsTrendPct: null };
  }
  ...
  return {
    ...
    contactsTrendPct: data.contactsTrendPct,
    eventsTrendPct: data.eventsTrendPct,
  };
}

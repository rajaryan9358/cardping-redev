 ...
 * once in the protected layout so every admin page stays live (coin
 * balances, block state, plan status — an admin actively acting on this
 * data can't be looking at a stale copy) without needing a hard reload.
 * Skips the very first render — that page's data already came from a
 * fresh SSR response, no need to double-fetch it. */

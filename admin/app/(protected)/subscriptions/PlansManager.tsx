    ...
    <div className="flex flex-col gap-4">
      ...
      <TableCard>
        <TableHeaderRow>
          ...
          <Th align="right">Annual (per mo / total)</Th>
        ...
        {plans.map((plan) => (
          <Tr key={plan.id}>
            ...
            <Td align="right">
              {plan.annual_monthly_price_inr !== null
                ? `₹${plan.annual_monthly_price_inr}/mo (₹${(plan.annual_monthly_price_inr * 12).toLocaleString("en-IN")}/yr)`
                : "—"}
            </Td>
